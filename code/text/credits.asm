...
org $0EB93D
	...
	%new_line(3) ; 14
	dw credits_roll_daniel1-credits_roll	; 787
	dw credits_roll_daniel2-credits_roll	; 795
	%new_line(2) ; 14
	dw credits_roll_hiroyuki1-credits_roll	; 7A3
	dw credits_roll_hiroyuki2-credits_roll	; 7B4
	%new_line(8) ; 14
